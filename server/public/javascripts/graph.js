...
//        return key !== "time";
//    }));
//    // creates a new array with function operated on each element of original array
...
//        };
//    }).filter(function (key) {
//        return (state.visibleSpecies.indexOf(key) > -1);
//    });
...
//        return d.name;
//    });
//    var specie = svg.selectAll(".specie").data(species).exit().enter().append("g").attr("class", "specie");
